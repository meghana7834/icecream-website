...
if(isset($_POST['delete_image'])){
    ...
    if(empty($_FILES['image']['name'])){
        $warning_msg[] = 'You must upload a new image when deleting the existing one.';
    } else {
        $empty_image = '';
        ...
        // Now, you can proceed to upload a new image
        $image = $_FILES['image']['name'];
        $image_size = $_FILES['image']['size'];
        $image_tmp_name = $_FILES['image']['tmp_name'];
        $image_folder = '../uploaded_file/' . $image;
...
<head>
    ...
    <title>wild scoops -Admin Dashboard page</title>
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="register">
                                ...
                                <div class="input-field">
                                    ...
                                    <select name="status" class="box">
                                        <option value="<?= $fetch_product['status']; ?>" disabled selected><?= $fetch_product['status']; ?></option>
                                ...
                                <div class="input-field">
                                   ...
                                   <?php }
                                    ...
                                    <div class="flex-btn">
                                        ...
                                        <input type="submit" name="delete_product" value="delete product" onclick="return confirm('Delete This Product');" class="btn">
                                    </div>
                            </form>
                        </div>
