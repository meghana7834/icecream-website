...
<head>
    ...
    <title>wild scoops -Admin unread message page</title>
                                ...
                                <div class="status" style="color: <?php if($fetch_order['status'] =='in progress'){
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="flex-btn">
                                            ...
                                            <input type="submit" name="delete_order" value="delete order" class="btn" onclick="return confirm('Delete this order permanently');">
                                        </div>
                                    </form>
                            </div>
                         <?php
