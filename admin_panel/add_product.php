...
<head>
    ...
    <title>wild scoops -Admin Add Products page</title>
                    ...
                    <div class="form-container">
                        <form action="" method="post" enctype="multipart/form-data" class="register">
                            <div class="input-field">
                                ...
                                <input type="text" name="name" maxlength="100" placeholder="Add a Product Name" required class="box">
                            </div>
