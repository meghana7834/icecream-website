...
<head>
    ...
    <title>sunny scoops delight-checkout page</title>
            ...
            <div class="flex">
                <div class="box">
                    ...
                    <div class="input-field">
                        ...
                        <input type="number" name="number" required maxlength="10" placeholder="Enter Your Mobile Number" class="input">
                    </div>
                    <div class="input-field">
                ...
                <div class="box">
                    ...
                    <div class="input-field">
                        ...
                        <input type="number" name="pin" required maxlength="6" min="0" placeholder="e.g 525252" class="input">
                    </div>
                </div>
            </div>
